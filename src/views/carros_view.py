...
def vista_carros(page: ft.Page, carros: list, on_volver):
    ...
    def tarjeta(c):
        ...
        return ft.Container(
            ...
            content=ft.Row([
                ft.Column([
                    ft.Text(f"🚗 {c.get_placa()}", weight="bold", color=NEGRO, size=13),
                    ft.Text(f"Marca: {c.get_marca()}  |  Modelo: {c.get_modelo()}  |  Año: {c.get_anio()}", color=GRIS, size=12),
    ...
    return ft.Column([
        ...
        ft.Container(
            ...
            content=ft.Column([
                ft.Text("AGREGAR CARRO", size=15, weight="bold", color=NEGRO),
                ...
                ft.Divider(color=BORDE, height=1),
                ft.Text("CARROS REGISTRADOS", size=15, weight="bold", color=NEGRO),
                lista_ui,
